    ...
    <main className="relative h-screen w-screen overflow-clip overflow-y-auto">
      ...
      <div className="top-0 -z-10 h-fit w-screen place-items-center overflow-x-clip bg-white dark:bg-black">
            ...
            <div className="flex flex-row items-center space-x-2">
              ...
              <Link
                className={cn(
                  ...
                  "group relative w-full justify-center rounded-sm transition-all duration-300 ease-out hover:ring-2 hover:ring-primary hover:ring-offset-2"
                )}
                href={"link.reducto.ai/star"}
              >
                <Star className="h-4 w-4 transition-all duration-300 group-hover:text-yellow-300" />
                Star on GitHub
              </Link>
              ...
              >
                ...
                <p className="ml-2">Discord Community</p>
              </Link>
            </div>
          </div>
        ...
        <div className="flex w-full  flex-col items-center gap-4 space-y-4 p-8 text-center md:p-8">
          <section className="mx-auto flex flex-col items-center space-y-8 pt-12">
            ...
            <div className="relative mx-auto grid w-full max-w-6xl grid-cols-2 gap-4 rounded-lg bg-background p-8 py-8 ">
