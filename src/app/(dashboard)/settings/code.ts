...
curl https://remembrall.vercel.app/api/v1/chat/completions // [!code ++] \\
...
fetch("https://remembrall.vercel.app/api/v1/chat/completions", { // [!code ++]
  method: "POST",
  headers: {
...
const configuration = new Configuration({
  ...
  basePath: "https://remembrall.vercel.app/api/v1",  // [!code ++]
  baseOptions: { // [!code ++:5]
    headers: {
...
openai.api_base = "https://remembrall.vercel.app/api/v1"  // [!code ++]
